...
<div class="content-wrapper" style="min-height: 690.2px;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0">Nilai Matriks Ideal Positif</h3>
          </div><!-- /.col -->        
                    ...
                    <div class="card-body table-responsive">
                        <div class="card-body">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                @if(is_array($solusiIdealPositif) && count($solusiIdealPositif) > 0)
                                    @foreach($solusiIdealPositif as $key => $value)
                                        <tr>
                                            <td>{{ $key }}</td>
                                            <td>{{ $value }}</td>
                                        </tr>
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0">Nilai Matriks Ideal Negatif</h3>
          </div><!-- /.col -->        
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>       
                    ...
                    <div class="card-body table-responsive">
                        <div class="card-body">
                            <table class="table table-striped">
                                ...
                                @if(is_array($solusiIdealNegatif) && count($solusiIdealNegatif) > 0)
                                    @foreach($solusiIdealNegatif as $key => $value)
                                        <tr>
                                            <td>{{ $key }}</td>
                                            <td>{{ $value }}</td>
                                        </tr>
