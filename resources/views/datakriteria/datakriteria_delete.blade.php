                        ...
                        <div class="card-body table-responsive">
                            <div class="card-body">
                                ...
                                <div class="form-login">
                                    ...
                                    <form action="{{ url('/datakriteria/destroy/' . $kriteriaList->id_kriteria) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                    <button type="submit" class="btn btn-simpan" name="hapus"
                                        style="width: 40%; margin: 20px auto;">
                                        <a href={{ url('/datakriteria/destroy/' . $kriteriaList->id_kriteria) }}>
                                            Yes
                                        </a>
                                    </button>
